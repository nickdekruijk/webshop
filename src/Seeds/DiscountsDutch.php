...
class DiscountsDutch extends Seeder
{
    ...
    public function run()
    {
        ...
        Discount::firstOrCreate([
            ...
            'description' => 'Zodra iemand voor 50 euro of meer in winkelwagen heeft zitten dan is verzending gratis, maar nu met coupon code.',
            // 'date_start' => null,
            // 'date_end' => null,
        ...
        Discount::firstOrCreate([
            'active' => false,
            'title' => '10% korting bij bestelling vanaf 25 euro',
            'description' => 'Zodra iemand deze coupon invoert en voor 25 euro of meer in winkelwagen heeft zitten dan krijgt deze 10% korting op het totaal bedrag ex. vezendkosten.',
            // 'date_start' => null,
            // 'date_end' => null,
        ...
        Discount::firstOrCreate([
            'active' => false,
            'title' => '15 euro korting bij bestelling vanaf 50 euro',
            'description' => 'Zodra iemand deze coupon invoert en voor 50 euro of meer in winkelwagen heeft zitten dan krijgt deze 15,- korting op het totaal bedrag ex. vezendkosten.',
            // 'date_start' => null,
            // 'date_end' => null,
